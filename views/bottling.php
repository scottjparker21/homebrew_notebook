				...
				<div id="icon-box" class="col-lg-10 col-lg-offset-2 col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1">
					...
					<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
						<div class="img-responsive">
					        <a href="#/bottling"><img class="animated pulse" ng-src="assets/img/bot_c.svg" style=""/></a>
				...
				<div class="form-register-with-email">
					<div class="form-white-background">
				  		...
				  		<div class="control-group" ng-class="{ 'has-error' : errornotes }">
				    		...
				    		<div class="controls">
				    			<?php echo	'<textarea class="notes-input" cols="30" rows="10" ng-init="formData.notes=' ."'" . $bottling['notes'] ."'" . '" type="text" name="notes" ng-model="formData.notes"/>'; ?>
