		...
		<div class="container" ng-app="">
			...
			<div class="row">
				<div id="icon-box" class="col-lg-10 col-lg-offset-2 col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1">
					<center>
					<div class="col-lg-2 col-lg-offset-2 col-md-2 col-md-offset-1 col-sm-2 col-sm-offset-2">
					...
					<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
						<div  ng-init="imgsrc2='assets/img/boil_b.svg'" ng-mouseover="imgsrc2='assets/img/boil_c.svg'" ng-mouseout="imgsrc2='assets/img/boil_b.svg'">
					        <img id="step-icon" ng-src="{{imgsrc2}}" style=""/>
					...
					<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
						<div id="step-icon" ng-init="imgsrc3='assets/img/hops_b.svg'" ng-mouseover="imgsrc3='assets/img/hops_c.svg'" ng-mouseout="imgsrc3='assets/img/hops_b.svg'">
					        <img id="step-icon" ng-src="{{imgsrc3}}" style=""/>
					...
					<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
						<div id="step-icon" ng-init="imgsrc4='assets/img/carboy_b.svg'" ng-mouseover="imgsrc4='assets/img/carboy_c.svg'" ng-mouseout="imgsrc4='assets/img/carboy_b.svg'">
					        <img id="step-icon" ng-src="{{imgsrc4}}" style=""/>
					...
					<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
						<div id="step-icon" ng-init="imgsrc5='assets/img/bot_b.svg'" ng-mouseover="imgsrc5='assets/img/bot_c.svg'" ng-mouseout="imgsrc5='assets/img/bot_b.svg'">
					        <img id="step-icon" ng-src="{{imgsrc5}}" style=""/>
